...
type SQLv1Antlr4Listener interface {
	...
	// EnterDatabase_or_table_list is called when entering the database_or_table_list production.
	EnterDatabase_or_table_list(c *Database_or_table_listContext)
	...
	// ExitDatabase_or_table_list is called when exiting the database_or_table_list production.
	ExitDatabase_or_table_list(c *Database_or_table_listContext)
